    ...
    <div className="space-y-6 pb-8">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          <div className="p-2 bg-asaka-500/20 rounded-lg">
            <Sparkles className="w-6 h-6 text-asaka-500" />
          </div>
          <div>
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-asaka-500 hover:bg-asaka-600 text-white rounded-lg font-medium transition"
        >
      ...
      {activeOffers.length > 0 && (
        <div className="space-y-3">
          <h2 className="text-lg font-semibold text-white flex items-center gap-2">
            <Clock className="w-5 h-5 text-asaka-500" />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {activeOffers.map((offer) => (
              <div
                key={offer.id}
                className="bg-[#242424] border border-[#333] rounded-lg p-4 hover:border-asaka-500/50 transition"
              >
                <div className="flex items-start justify-between mb-3">
                  ...
                  <div className="bg-asaka-500/20 px-3 py-1 rounded text-asaka-400 font-bold text-sm">
          ...
          <div className="space-y-2">
            {filteredOffers.map((offer) => {
              ...
              return (
                <div
                  key={offer.id}
                  className="bg-[#242424] border border-[#333] rounded-lg p-4 flex items-center justify-between hover:border-asaka-500/50 transition"
                >
                  <div className="flex-1 flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-1">
                        ...
                        {offer.showBanner && (
                          <span className="text-xs px-2 py-1 rounded bg-orange-900 text-asaka-600">
                            Bannière
                          </span>
                        )}
                      </div>
          ...
          <div className="bg-[#1a1a1a] border border-[#333] rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto">
              ...
              {[
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 font-medium border-b-2 transition ${
                    activeTab === id
                      ? 'border-asaka-500 text-asaka-400'
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-[#242424] border border-[#333] rounded-lg px-4 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-asaka-500"
                    />
                  </div>
                        ...
                        <button
                          ...
                          className={`p-3 rounded-lg border-2 text-center transition ${
                            editingOffer.holidayType === key
                              ? 'border-asaka-500 bg-asaka-500/10'
                              : 'border-[#333] bg-[#242424] hover:border-asaka-500/50'
                          }`}
                        >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-[#242424] border border-[#333] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-asaka-500"
                      />
                    </div>
                    <div>
                      <label className="block text-sm font-medium text-gray-300 mb-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="flex items-center gap-3 p-3 bg-[#242424] rounded-lg border border-[#333]">
                      <input
                        ...
                        className="w-5 h-5 rounded accent-asaka-500"
                      />
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <input
                        ...
                        className="flex-1 bg-[#242424] border border-[#333] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-asaka-500"
                      />
                    </div>
                  </div>
                </div>
              ...
              {activeTab === 'slides' && (
                <div className="space-y-6">
                    ...
                    >
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="https://..."
                          className="w-full bg-[#1a1a1a] border border-[#333] rounded-lg px-4 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-asaka-500"
                        />
                        {slide.imageUrl && (
                      ...
                      <div className="mt-4 p-3 bg-[#1a1a1a] rounded-lg border border-[#333]">
                        ...
                        <div className="bg-gradient-to-r from-gray-800 to-gray-900 rounded overflow-hidden">
                          ...
                          <div className="p-3">
                            ...
                            {slide.ctaText && (
                              <button className="mt-2 w-full bg-asaka-500 hover:bg-asaka-600 text-white text-xs font-medium py-2 rounded transition">
                                {slide.ctaText}
                              </button>
                            )}
                          </div>
                  ...
                  <button
                    ...
                    className="w-full px-4 py-3 bg-[#242424] border-2 border-dashed border-[#444] hover:border-asaka-500 text-asaka-400 font-medium rounded-lg transition flex items-center justify-center gap-2"
                  >
                    <Plus className="w-5 h-5" />
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <input
                        ...
                        className="flex-1 h-2 bg-[#333] rounded-lg appearance-none cursor-pointer accent-asaka-500"
                      />
                      <div className="bg-asaka-500/20 px-4 py-2 rounded-lg text-asaka-400 font-bold text-lg min-w-16 text-center">
                        ...
                        {editingOffer.deals.map((deal) => (
                          ...
                          >
                            ...
                            <input
                              ...
                              className="w-full bg-[#1a1a1a] border border-[#333] rounded-lg px-3 py-2 text-white placeholder-gray-600 focus:outline-none focus:border-asaka-500 text-sm"
                            />
                            ...
                            {deal.originalPrice > 0 && (
                              <div className="flex items-center gap-2 text-sm">
                                ...
                                <span className="text-asaka-400 font-bold">
            ...
            <div className="sticky bottom-0 bg-[#242424] border-t border-[#333] p-4 flex gap-3 justify-end">
              ...
              <button
                ...
                className="px-6 py-2 bg-asaka-500 hover:bg-asaka-600 text-white rounded-lg font-medium transition flex items-center gap-2"
              >
