    ...
    <div className="space-y-6 animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { label: 'Clients VIP', value: vipCount, icon: Users, color: 'text-asaka-500' },
        ].map((kpi, i) => (
            ...
            {categoryData.map((cat) => (
              <div key={cat.name}>
                ...
                <div className="w-full bg-gray-100 dark:bg-zinc-800 rounded-full h-1.5">
                  <div
                    className="bg-gradient-to-r from-asaka-500 to-asaka-400 h-1.5 rounded-full transition-all duration-700"
